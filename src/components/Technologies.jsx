    ...
    <div className="border-b border-neutral-800 pb-24">
      ...
      className="flex flex-wrap items-center justify-center gap-4">
        ...
        className="rounded-2xl border-4 border-neutral-800 p-4">
          <RiReactjsLine className="text-7xl text-blue-500" /> {/* React */}
        </motion.div>
        <motion.div
        ...
        animate="animate"
        className="rounded-2xl border-4 border-neutral-800 p-4">
          <FaCss3Alt className="text-7xl text-blue-600" /> {/* CSS */}
        </motion.div>
        <motion.div
        ...
        animate="animate"
        className="rounded-2xl border-4 border-neutral-800 p-4">
          <FaJsSquare className="text-7xl text-yellow-400" /> {/* JavaScript */}
        </motion.div>
        <motion.div
